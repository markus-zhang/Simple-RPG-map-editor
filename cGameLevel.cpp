...
void cGameLevel::UpdateCamera()
{
	...
	//}
	m_Camera.Update(
		MiddleNumber(m_PlayerX, GAME_MAP_WIDTH / 2, GetMapEastBorder() - GAME_MAP_WIDTH / 2 + 32),
		MiddleNumber(m_PlayerY, GAME_MAP_HEIGHT / 2, GetMapSouthBorder() - GAME_MAP_HEIGHT / 2 + 32));
}